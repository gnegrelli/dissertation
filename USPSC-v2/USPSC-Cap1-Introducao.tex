...
In Brazil, wind energy contributed in 42.4 TWh in 2017, resulting in a participation share of 7.2\%. But, while other sources, such as hydro and coal, had its share lowered, wind energy had the highest variation among sources comparing to 2016, increasing its contribution by 26.5\%. This results put wind energy in the \nth{4} source of electricity and \nth{3} between renewable sources, as shown in Figure \ref{fig: BRshare}. In therms of installed capacity, wind power plants appear in \nth{3} place, with 12.3 GW installed, behind hydro power (94.7 GW) and thermoelectric (41.6 GW) plants \cite{EPE2018}.

\begin{figure}[]
	\caption{Electricity generation by source}
	\begin{center}
		\includegraphics[scale=0.5]{Images/BRshare.eps}
	\end{center}
	\label{fig: BRshare}
	\legend{Source: EPE}
\end{figure}
