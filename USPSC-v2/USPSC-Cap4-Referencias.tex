...
%\begin{equation}
 %   \begin{cases}
  %      \dot{\Delta E'} = \frac{-1}{T_{o}X'}[X\Delta E' + (X - X')V_{0}\sin{\delta_{0}}\Delta \delta] + \frac{(X - X')\cos{\delta_{0}}}{T_{0}X'}\Delta V \\
   %     \dot{\Delta \delta} = \frac{(X-X')V_{0}}{T_{0}X'E'_{0}}\cdot\left(\frac{\sin{\delta_{0}}\Delta E'}{E'_{0}} - \cos{\delta_{0}}\Delta\delta\right) + \Delta\omega - \frac{(X - X')\sin{\delta_0}}{T_{o} X'E'_{0}}\Delta V \\
    %    \dot{\Delta \omega} = \frac{-V_{0}}{MX'}(\sin{\delta_{0}}\Delta E' + E'_{0}\cos{\delta_{0}}\Delta\delta) - \frac{E'_{0}\sin{\delta_{0}}{MX'}\Delta V
    %\end{cases}
    %\label{eq: xZIM}
%\end{equation}
