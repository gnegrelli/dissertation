...
\usepackage{algorithmic}		% escrever algoritmos
...
\begin{dedicatoria}
   ...
   \centering
   \noindent
   \textit{To J\'essica, my love.} \vspace*{\fill}
\end{dedicatoria}
% ---
...
I would like to thank everyone that helped me during this project.

First, to all my family members for the support. Special thanks to my wife, J\'essica, for her help and patience.

Secondly, to all my friends and colleagues at LACOSEP for the enriching discussions and moments of joy.

Finally, to the S\~ao Carlos School of Engineering at the University of S\~ao Paulo and its staff, in special to Prof. Dr. Elmer Cari, for the guidance during this project.
\end{agradecimentos}
% ---
...
\begin{epigrafe}
    \vspace*{\fill}
	\begin{flushright}
		\textit{``You miss 100\% of the shots you \\
...
\begin{simbolos}
	...
	\item[$\mathbf{y_{r}}$] Output measured on real system
...
% ---
\include{USPSC-Cap1-Introduction}
% ---
% Capítulo 2 - Modelling of Wind Turbine Generators
% ---
\include{USPSC-Cap2-WTG}
% ---
% Capítulo 3 - Parameter Estimation Process
% ---
\include{USPSC-Cap3-Estimation}
% ---
% Capítulo 4 - Software
% ---
\include{USPSC-Cap4-Software}
% ---
% Capítulo 5 - Results
% ---
\include{USPSC-Cap5-Results}
% ---
% Capítulo 6 - Conclusion
% ---
\include{USPSC-Cap6-Conclusion}
% ---
% Capítulo 7 - Ongoing Research
% ---
\include{USPSC-Cap7-Ongoing}
% ---
% Capítulo 8 - Publications
% ---
\include{USPSC-Cap8-Publications}
% ----------------------------------------------------------
