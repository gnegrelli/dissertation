...
\titulo{Development of Software for Wind Power System Model Identification}
\titleabstract{Model for theses and dissertations in \LaTeX\ using the USPSC class to the EESC}
